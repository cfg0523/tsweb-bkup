 ...
 * 组件资源扫描器：{@link com.techsen.tsweb.sys.util.AuthResourceScanner}
 */
...
public @interface AuthOperation {
    ...
    /**
     * 组件操作方法的名称<br/>
     * 没有指定时，被{@link com.techsen.tsweb.sys.util.AuthResourceScanner}扫描时，值为方法名
     */
     ...
     * 组件操作方法的区分字段<br/>
     * 用来区分重载的同名方法<br/>
     * 没有指定时，被{@link com.techsen.tsweb.sys.util.AuthResourceScanner}扫描时，值空字符串
     */
